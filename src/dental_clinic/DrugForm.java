...
public class DrugForm extends javax.swing.JFrame {
         ...
         int count,rowIndex=0;
            ...
            rs.beforeFirst();
             ...
             while(rs.next())
             {
                 ...
                 Data[rowIndex][3]=String.valueOf(rs.getInt("drug_fee"));
                 rowIndex++;
             }
...
public  void centeringTheForm(){
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
       ...
       if(id.equals("")==true || name.equals("")==true|| fee.equals("")==true|| description.equals("")==true)
       {
        ...
        try {
        String query ="insert into drug values ('"+id+"','"+name+"','"+description+"','"+fee+"')";
         st= db.con.createStatement();
         st.execute(query);
    ...
    private void newbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newbuttonActionPerformed
       this.clearAll();
        ...
        String query="select max(drug_id+1) as id from drug";
        try {
          st = db.con.createStatement();
         rs=st.executeQuery(query);
         if(rs.next())
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
       String  id = this.jTable1.getValueAt(this.jTable1.getSelectedRow(),0).toString();
        String query ="select * from drug where drug_id="+id;
        try {
            st = db.con.createStatement();
            rs =st.executeQuery(query);
            rs.next();
            this.idbox.setText(rs.getInt("drug_id")+"");
            this.namebox.setText(rs.getString("drug_name"));
            this.descriptionbox.setText(rs.getString("drug_description"));
            this.feebox.setText(String.valueOf(rs.getInt("drug_fee")));
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
     String id = this.idbox.getText();
       ...
       if(id.equals("")==true || name.equals("")==true|| fee.equals("")==true|| description.equals("")==true)
       {
        ...
        try {
        String query ="update  drug set drug_name='"+name+"', drug_description='"+description+"', drug_fee='"+fee+"' where drug_id='"+id+"'";
         st= db.con.createStatement();
         st.execute(query);
   ...
   String drug_id=this.idbox.getText();
       if(drug_id.equals("")==false)
       {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DrugForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
