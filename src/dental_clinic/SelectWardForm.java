...
public class SelectWardForm extends javax.swing.JFrame {
 public Statement st;
   public ResultSet rs;
public DatabaseConnection db;
public String ward_id;
    public SelectWardForm() {
        initComponents();
...
public  void centeringTheForm(){
    ...
    this.ward_id = this.jTable1.getValueAt(this.jTable1.getSelectedRow(),0).toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelectWardForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
