...
public class SelectPatientForm extends javax.swing.JFrame {
 public Statement st;
   public ResultSet rs;
...
public  void centeringTheForm(){
    ...
    String  patient_id = this.jTable1.getValueAt(this.jTable1.getSelectedRow(),0).toString();
     BookForm.patient_id=patient_id;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelectPatientForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
