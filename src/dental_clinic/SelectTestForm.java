...
public class SelectTestForm extends javax.swing.JFrame {
 public Statement st;
   public ResultSet rs;
...
public  void centeringTheForm(){
    ...
    this.test_id = this.testTable.getValueAt(this.testTable.getSelectedRow(),0).toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelectTestForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
